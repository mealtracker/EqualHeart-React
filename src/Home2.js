				...
				<div className="center_photos">
		            <div className="one-half">
		                <div className="iconbox icon-top">
	                        <div className="iconbox-icon"><img src="images/chart_meals.png" alt="Chart" /></div>
		           ...
		           <div className="one-half column-last">
		                <div className="iconbox icon-top">
	                        <div className="iconbox-icon"><img src="images/US-Map-places.png" alt="US Map" /></div>
	                        <p>Equal Heart is expanding to Arizona, California and Illinois in our goal to provide nutrious meals to underserved communities.</p>
		                </div>
		            </div>
				</div>
				<div className="center_photos">
