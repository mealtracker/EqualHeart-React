		...
		return (
			<div id="services">
				<div className="cropPicture">
					<img src="images/services_big.jpg" alt="team member with children" />
				</div>
				...
				<div className="centre">
			        ...
			        <div className="middle">
			            ...
			            <div className='services'>Crucial staff within every program of Equal Heart is facilitated through AmeriCorps. With this partnership, we receive program support and in turn provide sustainable economic opportunities for the communities we strive to help. The result are programs that help individuals while they work to help themselves.</div>
